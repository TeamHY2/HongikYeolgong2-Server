...
public enum ErrorCode{
    ...
    NOT_FOUND_FRIEND_REQUEST(40401, HttpStatus.NOT_FOUND, "친구 요청을 찾을 수 없습니다."),
    NOT_FOUND_FRIEND(40402, HttpStatus.NOT_FOUND, "존재하는 친구가 없습니다."),

    //Notification
    NOT_FOUND_NOTIFICATION(40403, HttpStatus.NOT_FOUND, "존재하는 알림이 없습니다.");
